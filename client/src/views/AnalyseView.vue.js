...
import { computePeriods, PERIOD_DAYS, } from '../composables/usePeriodAnalysis';
...
const analysis = computed(() => computePeriods(basket.items, prices.historyCache));
